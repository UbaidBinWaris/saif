    ...
    <section className="privacy-section">
      <div className="privacy-container">
        <header className="privacy-header">
                    <Image src={PATHS.LOGOS.MAIN} alt="GIXI AI Solutions Logo" className="privacy-logo" width={60} height={60} />
        ...
        <main className="privacy-content">
          <section>
            ...
            <p>GIXI AI Solutions we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website or use our services.</p>
          </section>
          <section>
        ...
        <footer className="privacy-footer">
          <Link href="/" className="privacy-link">Home</Link> |
          <Link href="/contact" className="privacy-link">Contact</Link>
