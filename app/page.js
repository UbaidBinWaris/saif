...
import HeaderHero from './Home/components/Header/HeaderHero';
import SectionOne from './Home/components/Section1/SectionOne';

// Dynamic imports for below-the-fold components
const Card = dynamic(() => import('./Home/components/Section2/card'), {
  loading: () => <div className="h-96 bg-gray-100 animate-pulse rounded" />
});

const SectionThree = dynamic(() => import('./Home/components/Section3/section3'), {
  loading: () => <div className="h-96 bg-gray-100 animate-pulse rounded" />
});

const SectionFour = dynamic(() => import('./Home/components/Section4/Section4'), {
  loading: () => <div className="h-96 bg-gray-100 animate-pulse rounded" />
});

const FAQs = dynamic(() => import('./Home/components/Section5/FAQs'), {
  loading: () => <div className="h-96 bg-gray-100 animate-pulse rounded" />
});
